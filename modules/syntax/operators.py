...
class OperatorCategory(Enum):
    ...
    DD_INVESTIGATION = "dd_investigation"  # dd:, dduk:, ddusp: (Due Diligence)
    LITIGATION = "litigation"              # lit:, lituk:, litus: (Litigation search)
    REGULATORY = "regulatory"              # reg:, reguk:, regus: (Regulatory search)
...
OPERATORS: Dict[str, OperatorDef] = {
    ...
    # ------------- Social Media Operators (SOCIALITE) -------------
    "soc:": OperatorDef(
        symbol="soc:",
        name="Social Media Investigation",
        category=OperatorCategory.IO_PREFIX,
        description="Investigate social media presence (auto-detect person or company via socialite_ai)",
        applies_to=["@PERSON", "@COMPANY"],
        example="soc: John Smith"
    ),
    "socp:": OperatorDef(
        symbol="socp:",
        name="Person Social Media Investigation",
        category=OperatorCategory.IO_PREFIX,
        description="Investigate person's social media presence (SOCIALITE person mode)",
        applies_to=["@PERSON"],
        example="socp: John Smith"
    ),
    "socc:": OperatorDef(
        symbol="socc:",
        name="Company Social Media Investigation",
        category=OperatorCategory.IO_PREFIX,
        description="Investigate company's social media presence (SOCIALITE company mode)",
        applies_to=["@COMPANY"],
        example="socc: Acme Corp"
    ),
    ...
    "ga?": OperatorDef(
        symbol="ga?",
        name="Google Analytics Reverse",
        category=OperatorCategory.LINK_ANALYSIS,
        description="Find domains sharing GA/GTM tracking codes",
        applies_to=["@SOURCE", "@DOMAIN"],
        granularity=ResultGranularity.UNIQUE,
        example="ga? :!domain.com"
    ),
    ...
    # ------------- DD Investigation Operators -------------
    "dd:": OperatorDef(
        symbol="dd:",
        name="Due Diligence",
        category=OperatorCategory.DD_INVESTIGATION,
        description="Full due diligence investigation (auto-detect person/company)",
        applies_to=["@PERSON", "@COMPANY"],
        example="dd: John Smith"
    ),
    "ddp:": OperatorDef(
        symbol="ddp:",
        name="Person Due Diligence",
        category=OperatorCategory.DD_INVESTIGATION,
        description="Person due diligence investigation",
        applies_to=["@PERSON"],
        example="ddp: John Smith"
    ),
    "ddc:": OperatorDef(
        symbol="ddc:",
        name="Company Due Diligence",
        category=OperatorCategory.DD_INVESTIGATION,
        description="Company due diligence investigation",
        applies_to=["@COMPANY"],
        example="ddc: Acme Corp"
    ),
    # UK DD
    "dduk:": OperatorDef(
        symbol="dduk:",
        ...
        category=OperatorCategory.DD_INVESTIGATION,
        description="UK due diligence (auto-detect person/company)",
        applies_to=["@PERSON", "@COMPANY"],
        example="dduk: Tesco Plc"
    ),
    "ddukp:": OperatorDef(
        symbol="ddukp:",
        name="UK Person DD",
        category=OperatorCategory.DD_INVESTIGATION,
        description="UK person due diligence",
        applies_to=["@PERSON"],
        example="ddukp: John Smith"
    ),
    "ddukc:": OperatorDef(
        symbol="ddukc:",
        name="UK Company DD",
        category=OperatorCategory.DD_INVESTIGATION,
        description="UK company due diligence",
        applies_to=["@COMPANY"],
        example="ddukc: Acme Ltd"
    ),
    # US DD
    "ddus:": OperatorDef(
        symbol="ddus:",
        name="US Due Diligence",
        category=OperatorCategory.DD_INVESTIGATION,
        description="US due diligence (auto-detect person/company)",
        applies_to=["@PERSON", "@COMPANY"],
        example="ddus: Acme Inc"
    ),
    "ddusp:": OperatorDef(
        symbol="ddusp:",
        name="US Person DD",
        category=OperatorCategory.DD_INVESTIGATION,
        description="US person due diligence",
        applies_to=["@PERSON"],
        example="ddusp: John Smith"
    ),
    "ddusc:": OperatorDef(
        symbol="ddusc:",
        name="US Company DD",
        category=OperatorCategory.DD_INVESTIGATION,
        description="US company due diligence",
        applies_to=["@COMPANY"],
        example="ddusc: Acme Inc"
    ),
    # DE DD
    "ddde:": OperatorDef(
        symbol="ddde:",
        name="DE Due Diligence",
        category=OperatorCategory.DD_INVESTIGATION,
        description="German due diligence",
        applies_to=["@PERSON", "@COMPANY"],
        example="ddde: Siemens AG"
    ),
    "dddep:": OperatorDef(
        symbol="dddep:",
        name="DE Person DD",
        category=OperatorCategory.DD_INVESTIGATION,
        description="German person due diligence",
        applies_to=["@PERSON"],
        example="dddep: Hans Mueller"
    ),
    "dddec:": OperatorDef(
        symbol="dddec:",
        name="DE Company DD",
        category=OperatorCategory.DD_INVESTIGATION,
        description="German company due diligence",
        applies_to=["@COMPANY"],
        example="dddec: Siemens AG"
    ),

    # ------------- Litigation Operators -------------
    "lit:": OperatorDef(
        symbol="lit:",
        name="Litigation Search",
        category=OperatorCategory.LITIGATION,
        description="Search litigation records (requires jurisdiction)",
        applies_to=["@PERSON", "@COMPANY"],
        example="lit: John Smith :UK"
    ),
    "lituk:": OperatorDef(
        symbol="lituk:",
        name="UK Litigation",
        category=OperatorCategory.LITIGATION,
        description="UK litigation search (BAILII, Gazette)",
        applies_to=["@PERSON", "@COMPANY"],
        example="lituk: Acme Ltd"
    ),
    "litus:": OperatorDef(
        symbol="litus:",
        name="US Litigation",
        category=OperatorCategory.LITIGATION,
        description="US litigation search (PACER, state courts)",
        applies_to=["@PERSON", "@COMPANY"],
        example="litus: Acme Inc"
    ),
    "litde:": OperatorDef(
        symbol="litde:",
        name="DE Litigation",
        category=OperatorCategory.LITIGATION,
        description="German litigation search",
        applies_to=["@PERSON", "@COMPANY"],
        example="litde: Siemens AG"
    ),
    ...
    "reg:": OperatorDef(
        ...
        category=OperatorCategory.REGULATORY,
        description="Search regulatory records (requires jurisdiction)",
        applies_to=["@PERSON", "@COMPANY"],
        example="reg: hedge fund :UK"
    ),
    "reguk:": OperatorDef(
        symbol="reguk:",
        name="UK Regulatory",
        category=OperatorCategory.REGULATORY,
        description="UK regulatory search (FCA Register)",
        applies_to=["@PERSON", "@COMPANY"],
        example="reguk: hedge fund"
    ),
    "regus:": OperatorDef(
        symbol="regus:",
        name="US Regulatory",
        category=OperatorCategory.REGULATORY,
        description="US regulatory search (SEC EDGAR, FINRA)",
        applies_to=["@PERSON", "@COMPANY"],
        example="regus: hedge fund"
    ),
    "regde:": OperatorDef(
        symbol="regde:",
        name="DE Regulatory",
        category=OperatorCategory.REGULATORY,
        description="German regulatory search (BaFin)",
        applies_to=["@PERSON", "@COMPANY"],
        example="regde: investment firm"
    ),
...
# Social media operators (SOCIALITE)
    "socp:", "socc:", "soc:",
# DD operators (longest first for parsing)
    "ddukp:", "ddukc:", "ddusp:", "ddusc:", "dddep:", "dddec:",
    "dduk:", "ddus:", "ddde:", "ddp:", "ddc:", "dd:",
    # Litigation operators
    "lituk:", "litus:", "litde:", "lit:",
    # Regulatory operators
    "reguk:", "regus:", "regde:", "reg:",
    # Command operators (imperative - DO THIS)
