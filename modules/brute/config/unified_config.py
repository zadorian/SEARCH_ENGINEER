...
class UnifiedConfig:
    ...
    @classmethod
    def get_api_key(cls, engine_code: str) -> str:
        """Get API key for a specific engine - needed for brute.py compatibility"""
        api_key_map = {
            'GO': os.getenv('GOOGLE_API_KEY', ''),
            'BI': os.getenv('BING_API_KEY', ''),
            'YA': os.getenv('YANDEX_API_KEY', ''),
            'BR': os.getenv('BRAVE_API_KEY', ''),
            'EX': os.getenv('EXA_API_KEY', ''),
            'NA': os.getenv('NEWSAPI_API_KEY', '') or os.getenv('NEWS_API_KEY', ''),
            'PW': os.getenv('PUBLICWWW_API_KEY', ''),
            'SS': os.getenv('SOCIALSEARCHER_API_KEY', ''),
            'GD': os.getenv('GDELT_API_KEY', ''),
            'GR': os.getenv('XAI_API_KEY', ''),
            'AL': os.getenv('ALEPH_API_KEY', ''),
            'FC': os.getenv('FIRECRAWL_API_KEY', ''),
            'AP': os.getenv('APIFY_TOKEN', ''),
        }
