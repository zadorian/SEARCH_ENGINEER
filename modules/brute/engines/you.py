...
class ExactPhraseRecallRunnerYou:
    ...
    def __init__(self, phrase: str, max_results_per_query: int = 100):
        ...
        self.queries = [
            ...
            f'"{phrase}"',  # YO1c: Standard quoted
            f'{quoted} filetype:pdf',  # YO2: PDF
            f'{quoted} filetype:doc',  # YO2: Word
            f'{quoted} site:gov',  # YO3: Gov
            f'{quoted} site:edu',  # YO3: Edu
            f'intitle:{quoted}',  # YO4: Title
            f'inurl:{quoted}',  # YO5: URL (will be processed by _process_exact_phrase_query)
        ]
