...
# BrightData Archive (17.5 PB cached web data) - lang{}/geo{}/cat{}/date{} native
try:
...
ENGINE_PARAM_MAP = {
    ...
    'brightdata': {
        # BrightData Archive uses native filters (auto-converted 2→3 letter codes)
        'lang_param': 'language_whitelist',   # ISO 639-3 codes via filter
        'geo_param': 'ip_country_whitelist',  # 2-letter country codes
        'cat_param': 'category_whitelist',    # Category names
        'date_param': 'min_date/max_date',    # yyyy-mm-dd format
    }
}
