...
# Primary: BACKDRILL globallinks bin
# Fallback: LINKLATER drill/go/bin
GLOBALLINKS_CANDIDATES = [
    # Primary location - BACKDRILL globallinks
    Path("/data/SEARCH_ENGINEER/modules/backdrill/globallinks/bin"),
    # JESTER scraping go bin
    Path("/data/SEARCH_ENGINEER/modules/jester/scraping/go/bin"),
    # LINKLATER drill location
