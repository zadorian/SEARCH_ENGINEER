...
CANONICAL SOURCES (cymonides/c1/):
- /data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/node_classes.json - The 4 dimensions
- /data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/node_types.json - Node type definitions
- /data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/relationships.json - NEXUS relationship ontology
- /data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/edge_types.json - Edge type definitions
...
CANONICAL_PATHS = {
    ...
    # NEXUS relationship ontology - CANONICAL SOURCE (cymonides/c1/)
    "relationships": "/data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/relationships.json",

    # Quick-lookup I/O node type definitions
    "types": "/data/SEARCH_ENGINEER/BACKEND/modules/input_output/matrix/types.json",

    # C-1 node classes (SUBJECT, LOCATION, NARRATIVE, NEXUS) - CANONICAL SOURCE
    "c1_node_classes": "/data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/node_classes.json",

    # C-1 node types - CANONICAL SOURCE
    "c1_node_types": "/data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/node_types.json",

    # Edge type definitions - CANONICAL SOURCE (cymonides/c1/)
    "edge_types": "/data/SEARCH_ENGINEER/BACKEND/modules/cymonides/c1/edge_types.json",
