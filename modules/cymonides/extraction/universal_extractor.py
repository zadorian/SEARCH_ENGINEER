...
def get_red_flag_entities():
    ...
    red_flag_path = Path(__file__).parent.parent / "golden_lists/red_flag_entities.json"
...
def get_golden_embeddings():
    ...
    cymonides_golden = Path(__file__).parent.parent / "golden_lists"
    matrix_golden = Path(__file__).parent.parent.parent.parent.parent / "input_output/matrix"
