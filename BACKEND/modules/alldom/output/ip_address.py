...
# 8 = ip_address (assuming - need to verify actual code)

class IpAddressOutputHandler:
    def __init__(self):
        self.results_root = Path(__file__).resolve().parent.parent / 'results' / 'ip_address'
    ...
    def process(self, value: str, context: Dict[str, Any], raw_data: Dict[str, Any] = None) -> Dict[str, Any]:
        node_id = self._generate_id('ip', value)
        edges = []
