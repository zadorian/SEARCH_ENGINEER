...
class PasswordOutputHandler:
    def __init__(self):
        self.results_root = Path(__file__).resolve().parent.parent / 'results' / 'password'
    ...
    def process(self, value: str, context: Dict[str, Any], raw_data: Dict[str, Any] = None) -> Dict[str, Any]:
        node_id = self._generate_id('password', value)
        edges = []
        ...
        node = {
            ...
            "label": value[:32] + "..." if len(value) > 32 else value,
            "value": value,
