...
Layers are about HOW OPERATORS ARE HANDLED, not search intensity.
...
# =============================================================================
# How TIERS (search intensity) and LAYERS (operator handling) interact.
#
# TIER 1 (Native):
#   - Use FAST engines (GO, BI, BR, DD, EX)
...
#
# TIER 4 (Nuclear):
#   - Tier 3 + link expansion
#   - Extract outlinks and backlinks
#   - Scrape everything
# =============================================================================

def get_tier_layer_strategy(tier: int, operators_used: List[str]) -> Dict[str, Any]:
    """
    Determine the optimal engine strategy based on tier and operators.

    Args:
        tier: Search tier (1-4)
        operators_used: List of operators in the query
    ...
    if tier == 1:
        ...
        strategy["rationale"] = "Tier 1: Fast engines with L1 priority"

    elif tier == 2:
        # Enhanced - all engines, accept L2
        ...
        strategy["rationale"] = "Tier 2: All engines, L2 acceptable, post-filter L3"

    elif tier >= 3:
        # Brute/Nuclear - all+slow engines, all layers
        ...
        strategy["rationale"] = f"Tier {tier}: Maximum recall, aggressive filtering"
