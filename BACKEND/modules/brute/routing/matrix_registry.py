...
UNIFIED_MATRIX: Dict[str, Any] = {
  ...
  "OBJECT": {
    ...
    "exact_phrase": {"L1": ["BS","GO","BI","AB","DD","YA","YC","BR","AR","PX","FC"], "L2": ["QW","ST","PX","FC"], "L3": ["EX","AO","PX","FC"]},
  ...
  "LOCATION": {
    ...
    "geographical": {
      "site":    {"L1": ["GO","BI","AB","BR","DD","YA","YC","BA","QW","EX","AR","MJ","SO","SZ","YH","PX","FC"], "L2": ["GO","BI","BR","DD","YA","YC","EX","YEP","ME","PX","FC"],
                   "L3": ["GO","BI","BR","DD","YA","YC","BA","QW","EX","NV","SZ","SGO","GR","W","PX","FC"]},
      "address": {"L1": ["GO","BI","BR","DD","YA","PX","FC"], "L2": ["YA","QW","PX","FC"], "L3": ["AO","PX","FC"]}
    },
    # Linguistic (language)
    "linguistic": {
      "language":    {"L1": ["GO","BI","AB","QW","ST","YA","YC","DD","BR","PX","FC"], "L2": ["GO","BI","BR","DD","YA","YC","QW","PX","FC"],
                       "L3": ["GO","BI","BR","DD","YA","YC","NV","SZ","SGO","AR","PX","FC"]}
    },
    # Textual (content fields)
    "textual": {
      "intitle": {"L1": ["GO","BI","AB","YA","BR","BA","DD","MJ","SO","SZ","YH","AR","PX","FC"], "L2": ["GO","BI","BR","DD","YA","YEP","PX","FC"],
                   "L3": ["GO","BI","BR","DD","YA","YC","NV","SZ","SGO","AR","PX","FC"]},
    ...
    "address": {
      "inurl":  {"L1": ["GO","BI","AB","BR","DD","YA","YC","BA","HFU","PW","MM","MJ","SO","SZ","YH","PX","FC"], "L2": ["GO","BI","BR","DD","YA","YC","HFU","MM","PX","FC"],
    ...
    "format": {
      ...
      "image":        {"L1": ["DD","BRI","YA","PX","FC"], "L2": ["EX","AO","PX","FC"], "L3": ["GO","BI","BR","PX","FC"]},
    ...
    "category": {
      "news":          {"L1": ["EX","QW","ST","BS","NA","GD","AR","PX","FC","GR","YO"], "L2": ["GO","BI","BR","DD","EX","AO","PX","FC","GR","YO"], "L3": ["GO","BI","BR","DD","W","PX","FC","GR","YO"]},
      ...
      "social_media": {"L1": ["SS","YT","YTU","RD","GR","XT"], "L2": ["GO","BI","BR","DD"], "L3": ["YA","ST"]},
      ...
      "public_records": {"L1": ["GO","BI","BR","DD","UKFOI","AR"], "L2": ["YA","ST"], "L3": ["AO"]},
      "legal":         {"L1": ["GO","BI","BR","DD","BAI","WLI","AR"], "L2": ["YA","ST"], "L3": ["AO"]}
    }
  }
}
